    ...
    <div className="bg-white">
      <div className="container mx-auto px-4 py-16 lg:py-24 max-w-4xl">
        ...
        <section className="prose prose-lg max-w-none text-slate-700 space-y-12">
          <h2 className="text-3xl font-black text-brand-dark">Saisonalität im Autohandel</h2>
          <p>
          ...
          <h2 className="text-3xl font-black text-brand-dark">Wertminderung durch Unfallschäden</h2>
          <p>
        ...
        <div className="my-16 bg-brand-dark rounded-[3rem] p-12 text-center text-white shadow-2xl">
          <h2 className="text-3xl lg:text-4xl font-black mb-6">Wissen ist Macht – Handeln ist Gold</h2>
        ...
        <section className="space-y-8">
          <h2 className="text-3xl font-black text-brand-dark text-center">Ratgeber FAQ</h2>
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="p-8 bg-white border border-slate-100 rounded-3xl">
                <h4 className="text-lg font-black text-brand-dark mb-4">{faq.q}</h4>
