  ...
  return (
    <div className="bg-white">
      <div className="container mx-auto px-4 py-16 lg:py-24 max-w-4xl">
        ...
        <p className="text-xl text-slate-600 leading-relaxed mb-12 font-medium italic border-l-4 border-brand-orange pl-6">
        ...
        <section className="prose prose-lg max-w-none text-slate-700 space-y-8">
          <h2 className="text-3xl font-black text-brand-dark">Die Grundlagen der Fahrzeugbewertung</h2>
          <p>
          ...
          <h3 className="text-2xl font-black text-brand-dark">Einflussfaktoren auf den Marktwert</h3>
          <p>
          ...
          <h2 className="text-3xl font-black text-brand-dark">Traditionelle vs. KI-basierte Bewertung</h2>
          <p>
          ...
          <h2 className="text-3xl font-black text-brand-dark">Der Prozess bei Meinautoverkauf.de</h2>
          <p>
        ...
        <div className="my-16 bg-brand-dark rounded-[3rem] p-12 text-center text-white relative overflow-hidden shadow-2xl">
          <div className="relative z-10">
            <h2 className="text-3xl lg:text-4xl font-black mb-6">Jetzt Fahrzeugwert gratis ermitteln</h2>
            ...
            <button 
              onClick={onCtaClick}
              className="bg-brand-orange text-white px-12 py-5 rounded-2xl font-black text-xl hover:bg-orange-600 transition-all shadow-xl"
            >
              Auto jetzt bewerten
            </button>
          </div>
        ...
        <section className="space-y-12">
          <h2 className="text-3xl font-black text-brand-dark text-center">Häufige Fragen zur Bewertung</h2>
          <div className="grid grid-cols-1 gap-6">
            {[
              ...
              <div key={i} className="bg-slate-50 p-8 rounded-3xl border border-slate-100">
                <h4 className="text-lg font-black text-brand-dark mb-3">{faq.q}</h4>
