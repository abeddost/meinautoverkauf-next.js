    ...
    <div className="bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-16 lg:py-24 max-w-4xl relative z-10">
        <div className="bg-white/90 backdrop-blur rounded-[2.5rem] p-8 lg:p-12 shadow-xl border border-slate-100">
          <h1 className="text-3xl lg:text-4xl font-black text-brand-dark mb-8">Impressum</h1>
          ...
          <div className="space-y-10 text-slate-700 leading-relaxed">
            ...
            <section className="space-y-2">
              <h2 className="text-xl lg:text-2xl font-black text-brand-dark">Verantwortlich für den Inhalt nach § 18 Abs. 2 MStV</h2>
              <p>Idris Sarwari</p>
              <p>Am Kuemmerling 41a</p>
              <p>55294 Bodenheim</p>
            </section>
            ...
            <section className="space-y-2">
              ...
              <p>
                ...
                <a className="text-brand-orange font-bold hover:underline" href="https://ec.europa.eu/consumers/odr/" target="_blank" rel="noreferrer">
            ...
            <section className="space-y-2">
              <h2 className="text-xl lg:text-2xl font-black text-brand-dark">Verbraucherstreitbeilegung / Universalschlichtungsstelle</h2>
              <p>
