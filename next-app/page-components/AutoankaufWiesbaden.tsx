        ...
        <div id="wiesbaden-content" className="max-w-4xl mx-auto relative">
          ...
          <section className="mt-16 bg-gradient-to-br from-slate-50 to-white rounded-3xl p-10 border border-slate-100">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link href="/autoankauf-hofheim-am-taunus" className="px-6 py-3 bg-white border-2 border-slate-200 rounded-2xl font-bold text-brand-dark hover:border-brand-orange hover:text-brand-orange transition-all">
