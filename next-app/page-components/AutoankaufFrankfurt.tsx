...
import { FRANKFURT_FAQS } from '@/lib/faqContent';
  ...
  return (
    <div className="bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-16 lg:py-24 max-w-5xl relative z-10">
        ...
        {/* Main Content */}
        <div id="frankfurt-content" className="max-w-4xl mx-auto relative">
          ...
          <section className="mt-16 bg-gradient-to-br from-slate-50 to-white rounded-3xl p-10 border border-slate-100">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="/autoankauf-wiesbaden" className="px-6 py-3 bg-white border-2 border-slate-200 rounded-2xl font-bold text-brand-dark hover:border-brand-orange hover:text-brand-orange transition-all">
                Autoankauf Wiesbaden →
              </Link>
              <Link href="/autoankauf-mainz" className="px-6 py-3 bg-white border-2 border-slate-200 rounded-2xl font-bold text-brand-dark hover:border-brand-orange hover:text-brand-orange transition-all">
                Autoankauf Mainz →
              </Link>
              <Link href="/autoankauf-offenbach" className="px-6 py-3 bg-white border-2 border-slate-200 rounded-2xl font-bold text-brand-dark hover:border-brand-orange hover:text-brand-orange transition-all">
                Autoankauf Offenbach →
              </Link>
              <Link href="/autoankauf-koblenz" className="px-6 py-3 bg-white border-2 border-slate-200 rounded-2xl font-bold text-brand-dark hover:border-brand-orange hover:text-brand-orange transition-all">
                Autoankauf Koblenz →
              </Link>
              <Link href="/autoankauf-hanau" className="px-6 py-3 bg-white border-2 border-slate-200 rounded-2xl font-bold text-brand-dark hover:border-brand-orange hover:text-brand-orange transition-all">
                Auch in Hanau verfügbar →
              </Link>
              <Link href="/autoankauf-wetzlar" className="px-6 py-3 bg-white border-2 border-slate-200 rounded-2xl font-bold text-brand-dark hover:border-brand-orange hover:text-brand-orange transition-all">
                Auch in Wetzlar verfügbar →
              </Link>
              <Link href="/autoankauf-bad-homburg-vor-der-hoehe" className="px-6 py-3 bg-white border-2 border-slate-200 rounded-2xl font-bold text-brand-dark hover:border-brand-orange hover:text-brand-orange transition-all">
                Auch in Bad Homburg verfügbar →
              </Link>
              <Link href="/autoankauf-oberursel" className="px-6 py-3 bg-white border-2 border-slate-200 rounded-2xl font-bold text-brand-dark hover:border-brand-orange hover:text-brand-orange transition-all">
                Auch in Oberursel verfügbar →
              </Link>
            </div>
            <div className="mt-8 text-center">
              ...
              <div className="flex flex-wrap justify-center gap-3">
                <Link href="/auto-bewerten" className="text-sm px-4 py-3 sm:py-2 bg-orange-50 text-brand-orange rounded-xl font-bold hover:bg-orange-100 transition-colors inline-block min-h-[44px] sm:min-h-0 flex items-center justify-center">
                  Auto Bewerten
                </Link>
                <Link href="/auto-verkaufen" className="text-sm px-4 py-3 sm:py-2 bg-orange-50 text-brand-orange rounded-xl font-bold hover:bg-orange-100 transition-colors inline-block min-h-[44px] sm:min-h-0 flex items-center justify-center">
                  Auto Verkaufen
                </Link>
                <Link href="/vorteile" className="text-sm px-4 py-3 sm:py-2 bg-orange-50 text-brand-orange rounded-xl font-bold hover:bg-orange-100 transition-colors inline-block min-h-[44px] sm:min-h-0 flex items-center justify-center">
                  Ihre Vorteile
                </Link>
                <Link href="/ratgeber" className="text-sm px-4 py-3 sm:py-2 bg-orange-50 text-brand-orange rounded-xl font-bold hover:bg-orange-100 transition-colors inline-block min-h-[44px] sm:min-h-0 flex items-center justify-center">
