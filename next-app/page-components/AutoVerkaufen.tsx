  ...
  return (
    <div className="bg-white relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none z-0">
        <div className="absolute -top-36 -right-28 w-[560px] h-[560px] bg-gradient-to-br from-orange-200/60 to-transparent rounded-full blur-3xl"></div>
        <div className="absolute top-[22%] -left-44 w-[560px] h-[560px] bg-gradient-to-tr from-blue-200/60 to-transparent rounded-full blur-3xl"></div>
        ...
        <div className="absolute top-[52%] left-[6%] w-40 h-40 border-2 border-blue-200/40 rounded-full"></div>
        <div className="absolute top-24 left-20 w-4 h-4 bg-orange-300 rounded-full"></div>
        <div className="absolute top-[38%] right-[32%] w-3 h-3 bg-blue-200 rounded-full"></div>
      ...
      <div className="container mx-auto px-4 py-16 lg:py-24 max-w-6xl relative z-10">
        ...
        {/* Main Content */}
        <div id="auto-verkaufen-content" className="max-w-4xl mx-auto">
          ...
          <section className="prose prose-lg max-w-none text-slate-700 space-y-8">
            ...
            <ul className="list-disc pl-6 space-y-3 font-medium">
              <li><strong>Sofortiges Angebot:</strong> In 2 Minuten erhalten Sie eine verbindliche <Link href="/auto-bewerten" className="text-brand-orange font-bold hover:underline">KI-gestützte Bewertung</Link>.</li>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center py-12 my-12">
              <div className="space-y-4 p-6 rounded-2xl bg-gradient-to-br from-slate-50 to-white border border-slate-100">
                ...
                <p className="text-sm text-slate-600 font-medium leading-relaxed">Geben Sie Fahrzeugdaten ein und erhalten Sie sofort eine <Link href="/auto-bewerten" className="text-brand-orange font-bold hover:underline">KI-gestützte Bewertung</Link> – kostenlos und unverbindlich.</p>
              </div>
              <div className="space-y-4 p-6 rounded-2xl bg-gradient-to-br from-slate-50 to-white border border-slate-100">
        ...
        <div className="max-w-4xl mx-auto">
          <section className="mt-14 bg-white rounded-3xl border border-slate-100 p-8">
            <h2 className="text-lg md:text-xl font-black text-brand-dark mb-4">Passende Ratgeber für den nächsten Schritt</h2>
            <div className="flex flex-wrap gap-3">
              {[
                { href: '/ratgeber/online-autoankauf-ablauf-7-schritte', label: 'Ablauf in 7 Schritten' },
                { href: '/ratgeber/unterlagen-autoverkauf-checkliste', label: 'Unterlagen-Checkliste' },
                { href: '/ratgeber/rechtssicherer-kaufvertrag-auto', label: 'Rechtssicherer Kaufvertrag' },
                { href: '/ratgeber/autoankauf-trotz-finanzierung', label: 'Verkauf trotz Finanzierung' },
                { href: '/ratgeber/auto-online-verkaufen-sofort-auszahlung', label: 'Online verkaufen & Auszahlung' },
                { href: '/ratgeber/autoabmeldung-nach-verkauf', label: 'Autoabmeldung nach Verkauf' },
              ].map((item) => (
                <Link
                  key={item.href}
                  href={item.href}
