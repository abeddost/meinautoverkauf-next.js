...
import { RUESSELSHEIM_FAQS } from '@/lib/faqContent';

interface Props {
  onCtaClick: () => void;
}

const AutoankaufRuesselsheimPage: React.FC<Props> = ({ onCtaClick }) => {
  return (
    <div className="bg-white relative overflow-hidden">
      {/* Decorative Background */}
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-[520px] h-[520px] bg-gradient-to-br from-green-200/50 to-transparent rounded-full blur-3xl"></div>
        ...
        <div className="absolute bottom-24 left-[12%] w-24 h-24 bg-green-200/40 rounded-full blur-xl"></div>
        ...
        <div className="absolute top-[40%] right-[32%] w-3 h-3 bg-green-200 rounded-full"></div>
        <div className="absolute bottom-16 right-16 w-5 h-5 bg-orange-200 rounded-full"></div>
        <img
          src="/elements/ruesselsheim-opel.webp"
          alt=""
          width={384}
          height={384}
      ...
      <div className="container mx-auto px-4 py-16 lg:py-24 max-w-5xl relative z-10">
        ...
        <div className="max-w-4xl mx-auto mb-16 relative">
          <div className="absolute -top-12 -left-12 w-24 h-24 bg-green-200/50 rounded-full blur-2xl"></div>
          ...
          <p className="text-lg text-slate-600 font-medium leading-relaxed mb-8 max-w-3xl">
            Sie möchten Ihr Auto in Rüsselsheim verkaufen – ohne Inserat, ohne Zeitverlust und zu einem
            fairen Preis? Wir kaufen Ihr Fahrzeug direkt an: Online bewerten, Termin vereinbaren, Geld
            erhalten – alles noch am selben Tag.
          </p>

          {/* Advantages box */}
          <div className="bg-gradient-to-br from-slate-50 to-white border border-slate-100 rounded-3xl p-8 shadow-sm">
            <h2 className="text-lg font-black text-brand-dark mb-5">Ihre Vorteile beim Autoankauf in Rüsselsheim</h2>
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {[
                'Kostenlose Online-Bewertung in 2 Minuten',
                'Sofortige Auszahlung nach Vertragsunterzeichnung',
                'Kostenlose Abholung in ganz Rüsselsheim & Kreis Groß-Gerau',
                'Abmeldung beim Straßenverkehrsamt Groß-Gerau inklusive',
                'Ankauf aller Marken – besonders Opel, Peugeot, Citroën',
        ...
        <section className="mb-16">
          <h2 className="text-xl lg:text-2xl font-black text-brand-dark mb-6">
            Rüsselsheim – die Opel-Stadt im Herzen des Rhein-Main-Gebiets
          </h2>
          <p className="text-slate-600 font-medium leading-relaxed mb-4">
            Kaum eine Stadt in Deutschland ist so eng mit der Automobilgeschichte verknüpft wie Rüsselsheim.
            Seit über 125 Jahren ist Opel hier zu Hause – heute als Teil des Stellantis-Konzerns. Diese
            Tradition bedeutet: In Rüsselsheim gibt es eine außergewöhnlich hohe Dichte an Opel-, Peugeot-
            und Citroën-Fahrzeugen, viele davon mit Flottenhistorie oder direktem Werksbezug.
          </p>
          <p className="text-slate-600 font-medium leading-relaxed mb-4">
            Ob gut gepflegter Firmenopel aus der Werksflotte, zuverlässiger Alltags-Astra oder leistungsstarker
            Insignia – wir kennen den lokalen Markt und bewerten Ihr Fahrzeug auf Basis aktueller Transaktionsdaten.
            Kein Bauchgefühl, kein veralteter Listenpreis.
          </p>
          <p className="text-slate-600 font-medium leading-relaxed">
            Gleichzeitig profitieren Sie von der geografischen Lage: Rüsselsheim liegt direkt an der A60 und
            ist über die A67 und A3 mit dem gesamten Rhein-Main-Raum verbunden. Der Frankfurter Flughafen ist
            in ca. 10 bis 15 Minuten erreichbar – ideal für eine schnelle Fahrzeugübergabe vor einer Reise.
          </p>
        </section>
        ...
        <section className="mb-16">
          <h2 className="text-xl lg:text-2xl font-black text-brand-dark mb-6">
            Autoankauf in allen Rüsselsheimer Stadtteilen & Umland
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100">
              <h3 className="font-black text-brand-dark mb-3 text-sm uppercase tracking-wide">Rüsselsheim Stadtteile</h3>
              <ul className="space-y-1.5 text-slate-600 font-medium text-sm">
                {['Kernstadt (Stadtmitte)', 'Bauschheim', 'Königstädten', 'Haßloch', 'Crumstadt', 'Goddelau', 'Leeheim', 'Nauheim'].map(d => (
            ...
            <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100">
              <h3 className="font-black text-brand-dark mb-3 text-sm uppercase tracking-wide">Kreis Groß-Gerau</h3>
              <ul className="space-y-1.5 text-slate-600 font-medium text-sm">
                {['Groß-Gerau', 'Mörfelden-Walldorf', 'Riedstadt', 'Gernsheim', 'Stockstadt', 'Bischofsheim', 'Trebur', 'Kelsterbach'].map(d => (
                  <li key={d} className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-brand-orange flex-shrink-0"></span>
                    {d}
                  </li>
            ...
            <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100">
              ...
              <ul className="space-y-1.5 text-slate-600 font-medium text-sm">
                {['Frankfurt Süd', 'Flughafen-Umgebung', 'Mainz-Kastel', 'Darmstadt', 'Langen', 'Neu-Isenburg', 'Dreieich', 'Weiterstadt'].map(d => (
                  <li key={d} className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-brand-orange flex-shrink-0"></span>
                    {d}
                  </li>
        ...
        <section className="mb-16">
          <h2 className="text-xl lg:text-2xl font-black text-brand-dark mb-8">
            So läuft der Autoankauf in Rüsselsheim ab
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                desc: 'Fahrzeugprüfung, Kaufvertrag, Schlüsselübergabe. Das Geld kommt per Überweisung noch am selben Tag. Abmeldung beim Straßenverkehrsamt Groß-Gerau übernehmen wir.',
              },
            ].map((item) => (
        ...
        <section className="mb-16">
          <h2 className="text-xl lg:text-2xl font-black text-brand-dark mb-6">
            Welche Fahrzeuge kaufen wir in Rüsselsheim an?
          </h2>
          <p className="text-slate-600 font-medium leading-relaxed mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            {[
              {
                title: 'Opel, Peugeot & Citroën',
                desc: 'Vom Corsa bis zum Vivaro, vom 308 bis zum Berlingo. Wir kennen den Markt für Stellantis-Fahrzeuge und zahlen faire, datenbasierte Preise.',
              },
              {
                title: 'Flottenfahrzeuge & Firmenwagen',
                desc: 'Gut gepflegte Dienstwagen mit Scheckheft erzielen oft sehr gute Preise. Wir bewerten schnell und diskret.',
              },
              {
                title: 'Hochkilometrige Alltagsautos',
                desc: 'Auch Fahrzeuge mit 150.000 km+ haben noch einen soliden Restwert – besonders wenn Export infrage kommt.',
              },
              {
                title: 'Unfallwagen & Fahrzeuge ohne TÜV',
                desc: 'Wir kaufen auch nicht fahrbereite Fahrzeuge, Unfallwagen oder Autos ohne gültige HU. Vollständige Unterlagen vorausgesetzt.',
              },
            ].map((cat) => (
        ...
        <section className="mb-16 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-3xl p-8 text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h2 className="text-lg lg:text-xl font-black mb-4">
              Fahrzeugübergabe nahe dem Frankfurter Flughafen
            </h2>
            <p className="text-slate-300 font-medium leading-relaxed mb-4">
              Sie fliegen bald und möchten Ihr Auto vorher noch verkaufen? Rüsselsheim liegt über die A60
              direkt am Frankfurter Flughafen – eine der kürzesten Verbindungen in ganz Rhein-Main.
              Wir stimmen Termin und Übergabepunkt flexibel auf Ihre Reisepläne ab.
            </p>
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-slate-300 font-medium">
              <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-brand-orange"></span>A60 direkt ab Rüsselsheim Stadtmitte</li>
              <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-brand-orange"></span>Ca. 10–15 Minuten zum Terminal 1/2</li>
              <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-brand-orange"></span>Kurzfristige Terminvereinbarung möglich</li>
              <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-brand-orange"></span>Übergabe auch in Kelsterbach/Cargo City</li>
            </ul>
          </div>
        </section>
        ...
        <section className="mb-16">
          <h2 className="text-xl lg:text-2xl font-black text-brand-dark mb-6">
            Autoankauf Rüsselsheim vs. Privatverkauf: Was lohnt sich mehr?
          </h2>
        ...
        {/* FAQ */}
        <FAQSection
          title="Häufige Fragen zum Autoankauf in Rüsselsheim"
          faqs={[...RUESSELSHEIM_FAQS]}
          sectionId="faq-ruesselsheim"
        />
        ...
        <div className="mt-16 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-[3rem] p-12 text-center text-white relative overflow-hidden border border-slate-700/60 shadow-2xl">
          ...
          <div className="relative z-10">
            <h2 className="text-xl lg:text-2xl font-black mb-4">Jetzt Auto in Rüsselsheim verkaufen</h2>
            <p className="text-slate-300 font-medium mb-8 max-w-xl mx-auto">
              ...
              Kernstadt, Bauschheim oder Groß-Gerau.
            </p>
            <button
              onClick={onCtaClick}
            ...
            <div className="flex flex-wrap justify-center gap-3 mt-6">
              {['Alle Stadtteile', 'Kreis Groß-Gerau', 'Sofort Geld'].map((badge) => (
...
export default AutoankaufRuesselsheimPage;
