...
const Footer: React.FC = () => {
  ...
  const serviceLinks = [
    ...
    { href: '/ratgeber', label: 'Verkaufs-Ratgeber' },
  ];
            ...
            <div className="space-y-4 text-sm font-bold">
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                ...
                <div className="mt-3 text-xs text-slate-400">
                  ...
                  <a href="mailto:info@meinautoverkauf.de" className="text-slate-200 hover:text-brand-orange">
                    info@meinautoverkauf.de
                  </a>
                </div>
              </div>
              <div className="flex flex-col gap-2">
                <Link href="/impressum" className="hover:text-brand-orange transition-colors">Impressum</Link>
                <Link href="/datenschutz" className="hover:text-brand-orange transition-colors">Datenschutz</Link>
                <button
                  type="button"
