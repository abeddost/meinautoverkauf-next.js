      ...
      <div className="bg-white rounded-[3rem] shadow-3xl overflow-hidden border border-gray-100 flex flex-col lg:flex-row">
        ...
        <div className="bg-brand-dark text-white p-12 lg:w-2/5 flex flex-col justify-center items-center text-center relative overflow-hidden">
          ...
          <div className="z-10 w-full">
            <h2 className="text-sm font-bold text-slate-400 uppercase tracking-[0.3em] mb-4">Direkt-Ankaufspreis</h2>
            <div className="text-6xl lg:text-7xl font-black text-brand-orange mb-2 tracking-tighter drop-shadow-2xl">
              {formattedPrice}
            </div>
            
            <div className="mb-8">
              <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest block mb-1">Markt-Handelsspanne:</span>
        ...
        <div className="p-10 lg:p-16 lg:w-3/5 bg-white">
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-2xl font-black text-brand-dark uppercase tracking-tight">Bewertungs-Logik</h3>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-2 text-[10px] font-bold text-slate-400 uppercase tracking-widest px-2">
                ...
                Ermittelt durch Echtzeit-Marktdatenanalyse (DAT/Schwacke Standard)
              </div>
            </div>
          </div>
