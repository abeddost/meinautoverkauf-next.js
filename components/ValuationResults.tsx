  ...
  return (
    <div className="max-w-4xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="bg-white rounded-2xl lg:rounded-2xl shadow-xl overflow-hidden border border-gray-100 flex flex-col lg:flex-row">
        ...
        <div className="bg-brand-dark text-white p-5 sm:p-6 lg:p-6 lg:w-[30%] flex flex-col justify-center items-center text-center relative">
          ...
          <div className="text-3xl sm:text-4xl lg:text-3xl font-black text-brand-orange mb-4 tracking-tighter">
            {formatPrice(valuation.estimatedPrice)}
          </div>
          
          <div className="w-full p-3 sm:p-4 bg-white/5 rounded-xl border border-white/10 mb-4 lg:mb-5">
        ...
        <div className="p-5 sm:p-6 lg:p-6 lg:w-[70%] bg-white flex flex-col justify-between">
          <div className="mb-6 lg:mb-8">
            ...
            <div className="relative mb-6 lg:mb-8">
              ...
              <p className="text-brand-dark text-base font-bold leading-snug italic text-slate-700">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {[
                ...
                <div key={i} className="flex gap-3 p-3 lg:p-3.5 rounded-xl bg-slate-50 border border-slate-100 hover:bg-orange-50 transition-colors">
          ...
          <div className="space-y-4">
            <button 
              onClick={onNext}
              className="w-full bg-brand-orange hover:bg-orange-600 text-white px-6 py-3.5 lg:py-4 rounded-xl font-bold text-base shadow-lg transition-all transform active:scale-95 shadow-orange-900/20"
            >
