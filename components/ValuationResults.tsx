      ...
      <div className="bg-white rounded-[3rem] shadow-3xl overflow-hidden border border-gray-100 flex flex-col lg:flex-row">
        ...
        <div className="bg-brand-dark text-white p-12 lg:w-[35%] flex flex-col justify-center items-center text-center relative">
          ...
          <div className="flex flex-col gap-3 w-full">
            <div className="flex items-center gap-3 text-xs font-bold text-slate-300 bg-white/5 px-4 py-3 rounded-xl border border-white/5">
        ...
        <div className="p-10 lg:p-16 lg:w-[65%] bg-white flex flex-col justify-between">
          <div className="mb-12">
            <div className="flex items-center gap-4 mb-8">
              <div className="w-12 h-12 bg-orange-100 rounded-2xl flex items-center justify-center text-brand-orange shadow-inner">
          ...
          <div className="space-y-6">
            <div className="flex flex-col sm:flex-row gap-4 items-stretch sm:items-center justify-between p-6 bg-brand-dark rounded-[2rem] text-white">
              <div className="flex items-center gap-6 divide-x divide-white/10">
                ...
                <div className="pl-6">
                  ...
                  <div className={`font-bold ${valuation.marketTrend === 'Up' ? 'text-green-400' : valuation.marketTrend === 'Down' ? 'text-red-400' : 'text-blue-400'}`}>
