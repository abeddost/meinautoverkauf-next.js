...
const ValuationForm: React.FC<ValuationFormProps> = ({ onValuationComplete }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert("Es gab einen Fehler bei der Bewertung. Bitte versuchen Sie es erneut.");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="bg-white rounded-[2.5rem] shadow-2xl p-8 md:p-12 border border-gray-100 -mt-16 relative z-20">
